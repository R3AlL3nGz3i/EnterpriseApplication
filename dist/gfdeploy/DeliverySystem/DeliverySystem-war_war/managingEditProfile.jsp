...
<%
    ...
    ResultSet resultSet = statement.executeQuery("select * from APP.MANAGINGSTAFF WHERE ID = '" + user_id.getId() + "' ");
...
<html>
   ...
   <head>
    ...
    <center>
        ...
        <form action="ManagingEditProfile" method="POST">             
            <table>
                <tr>
                    <td>Username:</td>
                ...
                <tr>
                    <td>Position: </td>
                    <td><input type="text" name="email" size="20"  value="<%=resultSet.getString("POSITION")%>"></td>
                </tr>
            </table>    
            <%
                }
