...
<%    
    ...
    if (id != null) {
        query = "select * from APP.MANAGINGSTAFF where ID like '% " + id + "%'";
    } else {
        query = "select * from APP.MANAGINGSTAFF";
    }
        ...
        <div id = "tableManaging" align="center" style="height:400px; ">             
            <TABLE >
                <tr>
                    ...
                    <td style = "width: 90px"><b>Position</b></td>
                ...
                <tr>
                    ...
                    <td><a href ="editStaff.jsp?id=<%=resultSet.getString("id")%>"  style= "font-size: 20px;">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href ="deleteStaff.jsp?id=<%=resultSet.getString("id")%>"  style= "font-size: 20px;">Delete </a>             
                        <% }%>
                </tr>
