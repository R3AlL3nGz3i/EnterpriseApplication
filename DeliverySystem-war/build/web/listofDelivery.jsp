...
<%    String url = "jdbc:derby://localhost:1527/sample";
    ...
    if (id != null) {
        query = "select * from APP.DELIVERYSTAFF where ID like '% " + id + "%'";
    } else {
        query = "select * from APP.DELIVERYSTAFF";
    }
...
<html>
    <head>
        ...
        <title>List of Delivery Staff</title>
    ...
    <body>
        ...
        <h2 align="center"><font><strong> List of Delivery Staff</strong></font></h2>
        <div id = "tableManaging" align="center">             
            <TABLE  >
                ...
                <tr>
                    ...
                    <td><a href ="editDeliveryStaff.jsp?id=<%=resultSet.getString("id")%>"  style= "font-size: 20px;">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href ="deleteDeliveryStaff.jsp?id=<%=resultSet.getString("id")%>"  style= "font-size: 20px;">Delete </a>             
                        <% }%>
                </tr>
        ...
        <div class = "register" style = "text-align:center; justify-content:center; align-items:center">
            ...
            <a href="registerDelivery.jsp" target="_blank"  > Register New Account</a>  &emsp;  &emsp;
        </div>
    </body>
</html>
