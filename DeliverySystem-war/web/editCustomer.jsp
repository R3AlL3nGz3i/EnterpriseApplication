...
<%    String ID = request.getParameter("id");
    ...
    ResultSet resultSet = statement.executeQuery("select * from APP.CUSTOMER where id = '" + ID + "' ");
...
<html>
    ...
    <center>
        <form action="editCustomerProcess.jsp" method="POST">    
            <div>
                <table>
                    <tr>
                        <td>ID</td>
            ...
            <div center>
                <p><input type="reset"value="Clear">  &nbsp &nbsp &nbsp
                    <input type="submit" value="Edit"></p> </div>
