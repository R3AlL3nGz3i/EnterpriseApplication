...
<html>
    ...
    <body>
        ...
        <form action="CustomerEditOrder" method="POST">             
            <center>
                <table>
                    <tr>
                        <td>Order ID</td>
                        <td readonly><input type="text" name="order_id" size="20"  value="<%=resultSet.getInt("ID")%>" readonly> </td>
                    </tr>
                    <tr>
                        <td>Customer ID:</td>
                    ...
                    <tr>
                        <td>Delivery status:</td>
                            <td> <input type="radio" id="Pending" name="order_status" value="Pending" readonly checked>
                            <label for="Pending">Pending</label>
                            <input type="radio" id="Delivering" name="order_status" value="Delivering"readonly>
                            <label for="Delivering">Delivering</label>
                            <input type="radio" id="Delivered" name="order_status" value="Delivered"readonly>
                    ...
                    <tr>
                        <td>Delivery ID: </td>
                        <td><input type="text" name="deliver_ID" size="20" value="<%=resultSet.getString("DELIVERY_ID")%>"readonly></td>
                    </tr>
                    <tr>
                        <td>Feedback: </td>
                        <td><input type="text" name="feedback" min="0" size="20" value="<%=resultSet.getString("FEEDBACK")%>" ></td>
                    </tr>
